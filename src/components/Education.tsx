...
//                         {edu.minor && (
//                           <p className="text-gray-600 dark:text-gray-400 mb-2">
//                             <span className="font-medium">Minor:</span> {edu.minor}
//                           </p>
//                         )}
...
//                     <p className="text-gray-600 dark:text-gray-400 text-sm">Issued {cert.year}</p>
//                     <p className="text-gray-500 dark:text-gray-400 text-sm mb-3">Credential ID: {cert.credentialId}</p>
//                     <a 
//                       href={cert.link}
//                       target="_blank"
